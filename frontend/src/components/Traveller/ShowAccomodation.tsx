    ...
    return (
        ...
        <Grid container spacing={2}>
            ...
            <Grid sx={{ mr:2,ml:2 }} >
                ...
                <p><span style={{ fontSize: '16px',fontWeight: 'bold' }}>Width: </span> {accoFormData.width} ft</p>
                </div>
                <div style={{ display:'flex','justifyContent': 'space-between' }}>
                <p><span style={{ fontSize: '16px',fontWeight: 'bold' }}>Height: </span> {accoFormData.height} ft</p>
