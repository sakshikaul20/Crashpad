            ...
            <Container>
                <Box sx={{ flexGrow: 1, m: 5, }} >
                    <Grid container spacing={2}>
                        <Grid xs={4} >
                            <img src='cardpayment.jpg' style={{ width: "100%", borderRadius: "20px" }} />
                            <Typography variant='h4' sx={{ textAlign: 'center', textDecoration: 'underline', pt: 5 }} > Liberty Sq</Typography>
                            <Typography color="gray" sx={{ textAlign: 'center', textDecoration: 'underline' }}>Location</Typography>
